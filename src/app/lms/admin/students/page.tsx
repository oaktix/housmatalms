                              ...
                              {sub && (
                                <div className="space-y-2 border-t border-border-main/50 pt-2.5 text-[11px] text-text-muted">
                                  <div className="flex justify-between items-center bg-bg-card p-2 rounded-lg border border-border-main">
                                    ...
                                    <button
                                      type="button"
                                      onClick={() => handleDownloadSubmission(sub.id, sub.content_file_name)}
                                      disabled={downloadingSubId === sub.id}
                                      className="text-primary hover:text-primary-glow font-bold flex items-center gap-0.5 text-[10px] disabled:opacity-50"
                                    >
                                      <Download className="w-3 h-3" />{" "}
                                      {downloadingSubId === sub.id ? "Loading…" : "Download"}
                                    </button>
                                  </div>
